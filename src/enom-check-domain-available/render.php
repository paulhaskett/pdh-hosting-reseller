...
// TODO save to database instead of api request each time and put this in the admin settings 
// to update the list.  also call gettlddetails but implement 
// it admin side so tlds can be selected to sell
$tldList = [];
try {
